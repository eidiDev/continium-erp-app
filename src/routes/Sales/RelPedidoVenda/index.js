...
import TabelaRelPedidoVenda from './tabelaRelPedidoVenda';
        ...
        <Row>
          ...
          <Col lg={4} md={4} sm={24} xs={24}>
            <Card type="inner" title="Açoes">
              ...
              <PrintReport data={this.state.resultData} />

              <PrintEtiqueta data={this.state.resultData} />
        ...
        <Row>
          <Col lg={20} md={20} sm={24} xs={24}>
            ...
            <Card bodyStyle={{ padding: "0" }}>
              <TabelaRelPedidoVenda data={this.state.resultData} loading={this.state.loading} />
